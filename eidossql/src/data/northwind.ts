// Northwind — the DSO 435 class database, generated verbatim from the course's
// northwind_postgreSQL.sql (loaded into PostgreSQL 16, then exported), so every
// query here runs against exactly the rows students have in DBeaver.
// Column names are lowercase because Postgres folds unquoted identifiers.
// Omitted: the binary columns categories.picture and employees.photo, and the
// two empty tables customercustomerdemo / customerdemographics.

import type { Dataset } from './datasets';

export const northwind: Dataset = {
  id: 'northwind',
  label: 'Northwind (DSO 435 class DB)',
  description: 'The full Northwind trading database used in DSO 435 — 830 orders, 2,155 order lines, 91 customers, 77 products — the same rows as the northwind_postgreSQL.sql loaded in DBeaver.',
  source: 'embedded',
  tables: [
    {
      name: 'categories',
      columns: [{ name: 'categoryid', type: 'integer' }, { name: 'categoryname', type: 'text' }, { name: 'description', type: 'text' }],
      rows: [
    ...
    {
      name: 'customers',
      columns: [{ name: 'customerid', type: 'text' }, { name: 'companyname', type: 'text' }, { name: 'contactname', type: 'text' }, { name: 'contacttitle', type: 'text' }, { name: 'address', type: 'text' }, { name: 'city', type: 'text' }, { name: 'region', type: 'text' }, { name: 'postalcode', type: 'text' }, { name: 'country', type: 'text' }, { name: 'phone', type: 'text' }, { name: 'fax', type: 'text' }],
      rows: [
    ...
    {
      name: 'employees',
      columns: [{ name: 'employeeid', type: 'integer' }, { name: 'lastname', type: 'text' }, { name: 'firstname', type: 'text' }, { name: 'title', type: 'text' }, { name: 'titleofcourtesy', type: 'text' }, { name: 'birthdate', type: 'date' }, { name: 'hiredate', type: 'date' }, { name: 'address', type: 'text' }, { name: 'city', type: 'text' }, { name: 'region', type: 'text' }, { name: 'postalcode', type: 'text' }, { name: 'country', type: 'text' }, { name: 'homephone', type: 'text' }, { name: 'extension', type: 'text' }, { name: 'notes', type: 'text' }, { name: 'reportsto', type: 'integer' }, { name: 'photopath', type: 'text' }],
      rows: [
    ...
    },
    {
      ...
      columns: [{ name: 'employeeid', type: 'integer' }, { name: 'territoryid', type: 'text' }],
      rows: [
        [1, "06897"],
        [1, "19713"],
        [2, "01581"],
    ...
    {
      name: 'orderdetails',
      columns: [{ name: 'orderid', type: 'integer' }, { name: 'productid', type: 'integer' }, { name: 'unitprice', type: 'numeric' }, { name: 'quantity', type: 'integer' }, { name: 'discount', type: 'numeric' }],
      rows: [
        [10248, 11, 14, 12, 0],
        [10248, 42, 9.8, 10, 0],
        [10248, 72, 34.8, 5, 0],
    ...
    {
      name: 'orders',
      columns: [{ name: 'orderid', type: 'integer' }, { name: 'customerid', type: 'text' }, { name: 'employeeid', type: 'integer' }, { name: 'orderdate', type: 'date' }, { name: 'requireddate', type: 'date' }, { name: 'shippeddate', type: 'date' }, { name: 'shipvia', type: 'integer' }, { name: 'freight', type: 'numeric' }, { name: 'ship_name', type: 'text' }, { name: 'shipaddress', type: 'text' }, { name: 'shipcity', type: 'text' }, { name: 'shipregion', type: 'text' }, { name: 'shippostalcode', type: 'text' }, { name: 'shipcountry', type: 'text' }],
      rows: [
    ...
    {
      name: 'products',
      columns: [{ name: 'productid', type: 'integer' }, { name: 'productname', type: 'text' }, { name: 'supplierid', type: 'integer' }, { name: 'categoryid', type: 'integer' }, { name: 'quantityperunit', type: 'text' }, { name: 'unitprice', type: 'numeric' }, { name: 'unitsinstock', type: 'integer' }, { name: 'unitsonorder', type: 'integer' }, { name: 'reorderlevel', type: 'integer' }, { name: 'discontinued', type: 'integer' }],
      rows: [
    ...
    {
      name: 'region',
      columns: [{ name: 'regionid', type: 'integer' }, { name: 'regiondescription', type: 'text' }],
      rows: [
        [1, "Eastern"],
        [2, "Western"],
        [3, "Northern"],
    ...
    {
      name: 'shippers',
      columns: [{ name: 'shipperid', type: 'integer' }, { name: 'companyname', type: 'text' }, { name: 'phone', type: 'text' }],
      rows: [
    ...
    {
      name: 'suppliers',
      columns: [{ name: 'supplierid', type: 'integer' }, { name: 'companyname', type: 'text' }, { name: 'contactname', type: 'text' }, { name: 'contacttitle', type: 'text' }, { name: 'address', type: 'text' }, { name: 'city', type: 'text' }, { name: 'region', type: 'text' }, { name: 'postalcode', type: 'text' }, { name: 'country', type: 'text' }, { name: 'phone', type: 'text' }, { name: 'fax', type: 'text' }, { name: 'homepage', type: 'text' }],
      rows: [
    ...
    {
      name: 'territories',
      columns: [{ name: 'territoryid', type: 'text' }, { name: 'territorydescription', type: 'text' }, { name: 'regionid', type: 'integer' }],
      rows: [
        ["01581", "Westboro", 1],
        ["01730", "Bedford", 1],
        ["01833", "Georgetow", 1],
    ...
    {
      name: 'us_states',
      columns: [{ name: 'stateid', type: 'integer' }, { name: 'statename', type: 'text' }, { name: 'stateabbr', type: 'text' }, { name: 'stateregion', type: 'text' }],
      rows: [
        [1, "Alabama", "AL", "south"],
        [2, "Alaska", "AK", "north"],
        [3, "Arizona", "AZ", "west"],
